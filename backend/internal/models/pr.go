...
// เวลาทุกช่องเก็บเป็น timestamp จริง การจัดรูปวันที่แบบไทยเป็นหน้าที่ของหน้าเว็บ
type PRItem struct {
	PRID    uint     `gorm:"primaryKey" json:"id"`
	...
	// PublishedAt เวลาที่เผยแพร่จริง ว่างแปลว่ายังไม่เคยขึ้นเว็บ
	PublishedAt *time.Time `json:"published_at"`
	// ExpiresAt วันหมดอายุ ว่างแปลว่าไม่มีกำหนด
